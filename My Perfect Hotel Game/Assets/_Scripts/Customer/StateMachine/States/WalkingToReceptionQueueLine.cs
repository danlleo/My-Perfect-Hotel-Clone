...
namespace Customer.StateMachine.States
{
    ...
    {
        public WalkingToReceptionQueueLine(CustomerStateManager currentContext, CustomerStateFactory customerStateFactory) : base(currentContext, customerStateFactory) { }
        ...
        {
            CurrentContext.Customer.CustomerReceptionQueueLinePositionChangedEvent.Event += CustomerReceptionQueueLinePositionChangedEvent;
